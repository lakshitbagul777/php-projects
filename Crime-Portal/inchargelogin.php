...
<body style="color: black;background-image: url(locker.jfif);background-size: 100%;background-repeat: no-repeat;back">
...
<div style="position: fixed;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;"> <b>Maharashta Police </b></h4>
</div>
