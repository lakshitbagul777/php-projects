...
<body style="color: black;background-image: url(locker.jfif);background-size: 100%;background-repeat: no-repeat;">
 ...
 <div>
    <form style="margin-top: 10%; margin-left: 40%;" method="post">
     ...
     <select name="loc" class="form-control" style="width: 250px;">
						...
						<?php
                        $loc=mysqli_query($conn,"SELECT * FROM `police_station`");
...
<div style="position: fixed;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;"><b>Maharashtra police</b></h4>
</div>
