...
<section id="aboutUs">
  <div class="container">
    <div class="heading text-left"> 
      ...
      <div class="wel_line"><center><h3>WELCOME TO INOX THEATRE  </h3></center></div>
    </div>
    <div class="row feature design">

      <div class="area1 columns left">
        
        <h5>INOX theatre is the most recognizable ﬁlm exhibition brands in the country which has high standards of ‘Luxury’, ‘Service’ & ‘Technology’.<br></h5>
                                                ...
                                                <div class="dvPatConetnt">
                                                    <div class="dvPatronDesc">
                                                        ...
                                                        <div class="dvPatronDescText">
                                                           Inox theatre is a leading chain of multiplex spread over Maharashtra.The multiplex shows Hindi, Marathi and English movies. It caters best in class cinematic experience to its patrons.
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="dvPatConetnt">
                                                    <div class="dvPatronDesc">
                                                        ...
                                                        <div class="dvPatronDescText">
                                                            Weekend popcorn, cold drink, snacks and 'masala' on screen. We are committed to provide our guests with an unparalleled cinema journey, which is underlined by the warmth of our top notch service !!
                                                        </div>
                                                    </div>
                                                </div>
